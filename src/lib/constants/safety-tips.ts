...
export const SAFETY_TIPS = {
  low: {
    ...
    tips: [
      ...
      'Eat something to slow alcohol absorption',
  ...
  moderate: {
    range: [0.05, 0.08],
    tips: [
      'You\'re approaching legal driving limit - consider stopping',
      'Drink water and eat food now',
  ...
  veryHigh: {
    ...
    tips: [
      ...
      'This is a medical emergency - use Medical Amnesty Policy',
    ],
    snackSuggestions: [
